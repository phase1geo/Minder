...
public class UndoStyleConnectionArrowSize : UndoStyleChange {
  ...
  public UndoStyleConnectionArrowSize( StyleAffects affects, int connection_arrow_size, MindMap map ) {
    ...
    _values.add( connection_arrow_size );
    load_styles( map );
  }

  protected override void load_style_value( Style style ) {
    _values.add( style.connection_arrow_size );
  }

  protected override void store_style_value( Style style, int index ) {
    style.connection_arrow_size = _values.get( index );
  }
